...
export default function Page() {
	return (
		<>
			<div className={'relative -z-10 flex h-screen w-screen flex-col items-center justify-center'}>
				...
				>
					<div className={'absolute h-full w-full p-3'}>
						<div className={'relative flex h-full w-full items-center justify-center rounded-sm bg-black/10'}>
							<h1 className={'text-center text-5xl text-white shadow-black text-shadow-lg lg:text-7xl xl:text-9xl'}>
								Lune de miel
							</h1>
						</div>
					</div>
			...
			<div className={'mx-auto flex max-w-7xl flex-col gap-32 px-2 py-16 md:px-4 xl:px-8'}>
				...
				<SectionComponent
					...
					text={
						<p className={''}>
							Notre prochain chapitre commence sous les palmiers et le soleil éclatant de la Floride !
							<br />
							<br />
							Cette terre de merveilles, connue pour ses plages de sable fin, ses eaux cristallines et son ambiance
							ensoleillée, sera le théâtre de notre aventure romantique.
							<br />
							<br />
							Nous sommes impatients de vivre ces moments magiques et de les partager avec vous à notre retour.
							Préparez-vous à entendre des histoires passionnantes et à voir des photos éblouissantes de notre escapade
							ensoleillée en Floride !
						</p>
					}
				/>
				...
				<SectionComponent
					...
					text={
						<p className={''}>
							...
							Là où la magie rencontre la réalité, nous nous préparons à plonger dans un univers de contes de fées, de
							parades éblouissantes et de moments féeriques.
							<br />
							<br />
							Nous sommes impatients de partager avec vous la joie et l&apos;émerveillement de cette étape fantastique
							de notre voyage.
						</p>
					}
				/>
				...
				<SectionComponent
					...
					text={
						<p className={''}>
							Suite à notre escapade enchantée à Disney World, nous poursuivons notre aventure en Floride en nous
							dirigeant vers l&apos;époustouflant univers d&apos;Universal Studios Orlando.
							<br />
							<br />
							Là, nous plongerons ensemble dans un monde où les films prennent vie, où chaque tournant révèle une
							nouvelle aventure palpitante.
							<br />
							<br />
							Nous sommes impatients de déambuler dans les allées thématiques, de nous émerveiller devant les spectacles
							éblouissants et de ressentir l&apos;excitation des montagnes russes à couper le souffle.
						</p>
					}
				/>
			</div>
